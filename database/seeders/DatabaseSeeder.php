...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        $admin = User::create([
            'name' => 'Admin',
            'email' => 'admin@faanesolutions.com',
        ...
        Service::insert([
            [
                'title' => 'Labour and Recruitment',
                'slug' => 'labour-and-recruitment',
                'excerpt' => 'Comprehensive recruitment solutions tailored to your workforce needs across all industries.',
                'description' => 'At Faane Solutions, we understand that the success of any organization hinges on the quality of its workforce. Our Labour and Recruitment services are designed to identify, attract, and secure top-tier talent that aligns with your organizational culture and objectives. We leverage extensive networks and cutting-edge recruitment methodologies to build a workforce that drives your business forward.',
                'highlights' => json_encode(['End-to-end recruitment process', 'Candidate screening and assessment', 'Temporary and permanent staffing', 'Industry-specific talent mapping', 'Onboarding support']),
                'icon' => 'users',
                'sort_order' => 1,
                'is_active' => true,
            ],
            [
                'title' => 'Employment and Outsourcing',
                'slug' => 'employment-and-outsourcing',
                'excerpt' => 'Strategic outsourcing solutions to optimize your operations and reduce overhead costs.',
                'description' => 'Streamline your operations and focus on your core business while we handle your workforce needs. Our Employment and Outsourcing solutions provide flexible, cost-effective staffing options that scale with your business. From managed workforce programs to complete departmental outsourcing, we deliver operational excellence.',
                'highlights' => json_encode(['Managed workforce solutions', 'Payroll management', 'Compliance and risk management', 'Scalable staffing models', 'Performance monitoring']),
                'icon' => 'briefcase',
                'sort_order' => 2,
                'is_active' => true,
            ],
            [
                ...
                'excerpt' => 'Expert immigration consultancy for work permits, visas, and relocation across Africa.',
                'description' => 'Navigate the complexities of international workforce mobility with confidence. Our Immigration Services team provides expert guidance on work permits, business visas, permanent residence applications, and cross-border relocation. We stay current with changing immigration laws to ensure smooth, compliant processing.',
                'highlights' => json_encode(['Work permit applications', 'Business and investor visas', 'Permanent residence support', 'Relocation assistance', 'Immigration compliance audits']),
                'icon' => 'globe-africa',
                'sort_order' => 3,
                'is_active' => true,
            ],
            [
                ...
                'excerpt' => 'Discreet and targeted executive search for C-suite and senior management positions.',
                'description' => 'Identifying exceptional leadership talent requires a specialized approach. Our Executive Search service combines deep industry knowledge with an extensive network of high-caliber professionals to find leaders who will transform your organization. We conduct thorough assessments to ensure cultural fit and strategic alignment.',
                'highlights' => json_encode(['C-suite and board-level recruitment', 'Confidential search process', 'Leadership assessment and profiling', 'Industry-specific expertise', 'Succession planning support']),
                'icon' => 'star',
                'sort_order' => 4,
                'is_active' => true,
            ],
            [
                'title' => 'Foreign Labour Sourcing',
                'slug' => 'foreign-labour-sourcing',
                'excerpt' => 'Access skilled international talent pools to fill critical skill gaps in your organization.',
                'description' => 'Expand your talent pool beyond borders. Our Foreign Labour Sourcing service connects you with qualified professionals from across Africa and beyond. We manage the entire process from sourcing and vetting to immigration and relocation, making international hiring seamless and compliant.',
                'highlights' => json_encode(['International talent sourcing', 'Skilled worker recruitment', 'Visa and permit processing', 'Relocation coordination', 'Cross-cultural integration support']),
                'icon' => 'airplane',
                'sort_order' => 5,
                'is_active' => true,
            ],
            [
                ...
                'excerpt' => 'Integrated facility management services to maintain safe, efficient work environments.',
                'description' => 'Create and maintain optimal work environments with our comprehensive Facility Management services. From maintenance and security to space planning and sustainability initiatives, we ensure your facilities operate efficiently, safely, and cost-effectively, allowing you to focus on your core business objectives.',
                'highlights' => json_encode(['Preventive maintenance', 'Security services', 'Space planning and management', 'Cleaning and janitorial', 'Sustainability consulting']),
                'icon' => 'building',
                'sort_order' => 6,
                'is_active' => true,
            ],
        ...
        TeamMember::insert([
            [
                ...
                'bio' => 'Mwila brings over 15 years of experience in HR consultancy and labour law. She founded Faane Solutions with a vision to transform workforce management across Africa.',
                'sort_order' => 1,
                'is_active' => true,
            ],
            [
        ...
        Testimonial::insert([
            [
                ...
                'content' => 'Faane Solutions transformed our recruitment process. Their understanding of our industry and ability to source top-tier talent has been exceptional. We have filled 15 critical positions in just 3 months.',
                'rating' => 5,
                'is_active' => true,
            ],
            [
                ...
                'content' => 'The immigration services provided by Faane Solutions were invaluable in helping us relocate our expatriate team. Their expertise in Zambian immigration law saved us months of processing time.',
                'rating' => 5,
                'is_active' => true,
            ],
            [
                ...
                'content' => 'We have been working with Faane Solutions for our outsourcing needs for over 3 years. Their managed workforce program has significantly reduced our operational costs while improving efficiency.',
                'rating' => 5,
                'is_active' => true,
            ],
        ]);
        ...
        JobListing::insert([
            [
                ...
                'description' => 'As a Senior Recruitment Consultant at Faane Solutions, you will play a pivotal role in expanding our recruitment division. You will manage client relationships, source candidates across multiple sectors, and lead a team of junior recruiters. The ideal candidate has a proven track record in agency recruitment and strong business development skills.',
            ...
            [
                ...
                'description' => 'We are looking for a dynamic Business Development Manager to drive Faane Solutions\' growth across Zambia and the region. You will identify new business opportunities, build strategic partnerships, and expand our client base across all service lines.',
        ...
        Setting::insert([
            ...
            ['key' => 'social_linkedin', 'value' => 'https://linkedin.com/company/faanesolutions', 'group' => 'social'],
            ['key' => 'social_facebook', 'value' => 'https://facebook.com/faanesolutions', 'group' => 'social'],
            ['key' => 'social_twitter', 'value' => 'https://twitter.com/faanesolutions', 'group' => 'social'],
            ['key' => 'social_instagram', 'value' => 'https://instagram.com/faanesolutions', 'group' => 'social'],
